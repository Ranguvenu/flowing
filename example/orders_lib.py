    ...
    try:
        ...
        if transaction_type == "SELL":
            ...
            try:
                ...
                SET sell_orderid = %s, sell_index = %s, nse_index = %s, bought_at = %s, lot_price = %s, status = %s, symboltoken = %s
            ...
            cursor = conn.cursor()
            insert_query = """
            INSERT INTO order_records (symbol, orderid, sell_index, nse_index, bought_at, lot_price, status, symboltoken, type)
